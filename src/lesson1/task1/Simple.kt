 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (((initial + initial * (percent * 0.01)) + (initial + initial * (percent * 0.01)) * (percent * 0.01)) + ((initial + initial * (percent * 0.01)) + (initial + initial * (percent * 0.01)) * (percent * 0.01)) * (percent * 0.01))
